...
{
    [TestFixture]
    public class GSLPayableApprenticeshipEarningsTests
    {
        private GSLApprenticeshipEarningsEvent earningEventPayment;
        ...
        public void Setup()
        {
            ...
            earningEventPayment = new GSLApprenticeshipEarningsEvent()
            {
                Ukprn = 12345,
                SfaContributionPercentage = 0.9m,
                JobId = 123,
